...
| 아카이브 | URL | 특징 | 상태 |
|----------|-----|------|------|
| UbuWeb | ubu.com | 의도적으로 조악한 인터페이스. 아방가르드 정신의 형식화 | ✓ 완료 |
| Low-Tech Magazine Archive | solar.lowtechmagazine.com | 태양광 서버, 디더링 이미지. 지속가능성이 형식에 체화됨 | |
| Cameron's World | cameronsworld.net | 지오시티즈 잔해로 만든 콜라주. 웹의 역사를 웹의 유물로 | |
| 지암일기 | jiamdiary.info | 조선시대 일기를 데이터 시각화로. 고문서와 디지털의 만남 | |
| Skeuomorphic Library / P-DPA | p-dpa.net | 스큐어모픽 인터페이스로 디지털 출판 아카이빙 | |
| Edible Archive | ediblearchive.com | 먹을 수 있는 아카이브. 물질성과 기록의 관계 | |
| ASCII Art Archive | asciiart.eu | ASCII 아트 아카이브. 텍스트 기반 시각 문화의 수집 | |
...
| 아카이브 | URL | 특징 | 상태 |
|----------|-----|------|------|
| Women Writing Architecture | womenwritingarchitecture.org | 페미니스트 건축 서지. taxonomy가 곧 관계 모델 | ✓ 완료 |
| Takachizu | takachizu.org | 커뮤니티 기반 지도 아카이브. 장소와 기억의 관계 | |
| 퀴어락 | queerarchive.org | 성소수자 아카이브의 분류 체계 | |
| The Creative Independent | thecreativeindependent.com | 인터뷰 아카이브의 구조. 창작자 연결 방식 | |
| BugGuide.Net | bugguide.net | 시민 과학 아카이브. 분류학과 참여의 교차점 | |
...
| 아카이브 | URL | 특징 | 상태 |
|----------|-----|------|------|
| 서울시립 미술아카이브 SeMA AA | sema.seoul.go.kr/semaaa | 한국 공공 미술아카이브의 형식 | |
| Letterform Archive | oa.letterformarchive.org | 온라인 아카이브의 모범 사례? | |
...
| 한국문학 비평 아카이브 | munjang.or.kr | 한국문학 비평 DB | |
| GCED Clearinghouse | gcedclearinghouse.org | 세계시민교육 자료 허브. UNESCO 기반 | |
...
| 아카이브 | URL | 특징 | 상태 |
|----------|-----|------|------|
| Experimental Jetset | jetset.nl | 디자인 스튜디오의 자기 아카이빙 | |
| W. Ross Ashby Digital Archive | ashby.info | 학자의 사후 아카이브 | |
| Lucy Ives | lucy-ives.com | 작가 웹사이트의 형식 | |
...
| Monoskop | monoskop.org | 미디어 아트·이론 위키 아카이브 | |
...
| 건축의 아카이브 해제 | unarchivingarchitecture.ethz.ch | ETH Zurich. 아카이브 해체를 주제로 한 심포지엄 | |
